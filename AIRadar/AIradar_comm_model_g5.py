...
RADAR_COMM_CONFIGS_G2 = {'CN0566_TRADITIONAL': {'mode': 'TRADITIONAL', 'fc': 10250000000.0, 'mod_order': 16, 'radar_B': 500000000.0, 'radar_T': 0.0005, 'radar_fs': 2000000.0, 'comm_B': 40000000.0, 'comm_fs': 61440000.0, 'comm_fft_size': 64, 'comm_cp_len': 16, 'channel_model': 'multipath', 'R_max': 150.0, 'num_rx': 1, 'cfar_params': {'num_train': 12, 'num_guard': 4, 'threshold_offset': 25, 'nms_kernel_size': 7}, 'adaptive_cfar': True, 'csi_error': 0.1, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.005, 'k_shape': 2.0, 'range_exponent': 2.5, 'weather_clutter': False, 'weather_intensity': 0.02, 'doppler_spread': 3.0}}, 'CN0566_OTFS_ISAC': {'mode': 'OTFS', 'fc': 10250000000.0, 'mod_order': 4, 'B': 40000000.0, 'fs': 40000000.0, 'N_doppler': 64, 'N_delay': 512, 'T_symbol': 1.28e-05, 'channel_model': 'multipath', 'R_max': 100.0, 'num_rx': 1, 'cfar_params': {'num_train': 4, 'num_guard': 2, 'threshold_offset': 25, 'nms_kernel_size': 5, 'min_range_m': 2.0, 'min_speed_mps': 0.0, 'notch_doppler_bins': 0}, 'adaptive_cfar': True, 'csi_error': 0.15, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.03, 'k_shape': 1.5, 'range_exponent': 2.0, 'weather_clutter': False, 'weather_intensity': 0.01, 'doppler_spread': 5.0}}, 'Automotive_77GHz_LongRange': {'mode': 'TRADITIONAL', 'fc': 77000000000.0, 'mod_order': 4, 'radar_B': 1500000000.0, 'radar_T': 4e-05, 'radar_fs': 51200000.0, 'comm_B': 400000000.0, 'comm_fs': 512000000.0, 'comm_fft_size': 1024, 'comm_cp_len': 72, 'channel_model': 'multipath', 'R_max': 100.0, 'num_rx': 1, 'cfar_params': {'num_train': 10, 'num_guard': 4, 'threshold_offset': 25, 'nms_kernel_size': 7}, 'adaptive_cfar': True, 'csi_error': 0.05, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.008, 'k_shape': 3.0, 'range_exponent': 3.0, 'weather_clutter': True, 'weather_intensity': 0.03, 'doppler_spread': 2.0}}, '8QAM_MediumRange': {'mode': 'TRADITIONAL', 'fc': 28000000000.0, 'mod_order': 8, 'radar_B': 800000000.0, 'radar_T': 0.0001, 'radar_fs': 40000000.0, 'comm_B': 100000000.0, 'comm_fs': 122880000.0, 'comm_fft_size': 256, 'comm_cp_len': 32, 'channel_model': 'multipath', 'R_max': 80.0, 'num_rx': 1, 'cfar_params': {'num_train': 12, 'num_guard': 4, 'threshold_offset': 25, 'nms_kernel_size': 7}, 'adaptive_cfar': True, 'csi_error': 0.08, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.007, 'k_shape': 2.5, 'range_exponent': 2.5, 'weather_clutter': True, 'weather_intensity': 0.025, 'doppler_spread': 2.5}}, 'XBand_10GHz_MediumRange': {'mode': 'TRADITIONAL', 'fc': 10000000000.0, 'mod_order': 16, 'radar_B': 1000000000.0, 'radar_T': 0.00016, 'radar_fs': 40000000.0, 'comm_B': 40000000.0, 'comm_fs': 40000000.0, 'comm_fft_size': 64, 'comm_cp_len': 16, 'channel_model': 'multipath', 'R_max': 100.0, 'num_rx': 1, 'cfar_params': {'num_train': 24, 'num_guard': 8, 'threshold_offset': 25, 'nms_kernel_size': 9}, 'adaptive_cfar': True, 'csi_error': 0.1, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.006, 'k_shape': 2.5, 'range_exponent': 2.5, 'weather_clutter': True, 'weather_intensity': 0.04, 'doppler_spread': 4.0}}, 'AUTOMOTIVE_TRADITIONAL': {'mode': 'TRADITIONAL', 'fc': 77000000000.0, 'mod_order': 16, 'radar_B': 1500000000.0, 'radar_T': 6e-05, 'radar_fs': 50000000.0, 'comm_B': 400000000.0, 'comm_fs': 512000000.0, 'comm_fft_size': 1024, 'comm_cp_len': 72, 'channel_model': 'multipath', 'R_max': 250.0, 'num_rx': 4, 'cfar_params': {'num_train': 16, 'num_guard': 4, 'threshold_offset': 25, 'nms_kernel_size': 9}, 'adaptive_cfar': True, 'csi_error': 0.01, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.01, 'k_shape': 2.0, 'range_exponent': 2.0, 'weather_clutter': True, 'weather_intensity': 0.05, 'doppler_spread': 3.0}}, 'AUTOMOTIVE_OTFS_ISAC': {'mode': 'OTFS', 'fc': 77000000000.0, 'mod_order': 4, 'B': 1536000000.0, 'fs': 51200000.0, 'N_doppler': 128, 'N_delay': 512, 'T_symbol': 4e-05, 'channel_model': 'multipath', 'R_max': 100.0, 'num_rx': 1, 'cfar_params': {'num_train': 16, 'num_guard': 8, 'threshold_offset': 22, 'nms_kernel_size': 11, 'min_range_m': 2.0, 'min_speed_mps': 0.0, 'notch_doppler_bins': 0}, 'adaptive_cfar': True, 'csi_error': 0.1, 'clutter_params': {'ground_clutter': True, 'ground_intensity': 0.03, 'k_shape': 2.5, 'range_exponent': 2.5, 'weather_clutter': True, 'weather_intensity': 0.04, 'doppler_spread': 2.5}}}
...
class RadarTrainer:
    def __init__(self, model: nn.Module, device: torch.device, pos_weight: float = 5.0):
        self.model = model
        self.device = device
...
def train_radar_pipeline(cfg: RunConfig, device: torch.device) -> Dict[str, Any]:
    ...
    model = GeneralizedRadarNet(in_ch=1, base_ch=48, cond_dim=64).to(device)
    if cfg.radar_ckpt:
        load_checkpoint_if_exists(model, cfg.radar_ckpt, device)

    trainer = RadarTrainer(model, device, pos_weight=cfg.radar_pos_weight)
    ...
    snr_results = trainer.evaluate_against_cfar_sweep(
        config_name=seen_configs[0],
        sweep_type="snr",
        sweep_values=list(cfg.eval_snr_list),
        num_samples=15,
        save_root=cfg.data_root,
    )
    plot_radar_sweep(snr_results, os.path.join(out_dir, "radar_snr_vs_cfar.png"))
    ...
    plot_radar_sweep(cnr_results, os.path.join(out_dir, "radar_cnr_vs_cfar.png"))
    ...
    plot_radar_sweep(rcs_results, os.path.join(out_dir, "radar_rcs_vs_cfar.png"))
    ...
    summary = {
        ...
        "cnr_sweep": cnr_results,
        "rcs_sweep": rcs_results,
    }
...
def train_comm_pipeline(cfg: RunConfig, device: torch.device, model_name: str = "adaptive") -> Dict[str, Any]:
    ...
    for channel_mode in ["awgn", "realistic"]:
        for config_name in seen_configs[: min(2, len(seen_configs))]:
            ...
            snr_reports[key] = res
            plot_comm_sweep(res, os.path.join(out_dir, f"ber_snr_{key}.png"), title=f"{config_name} - {channel_mode}")
...
def run_full_evaluation(cfg: RunConfig, device: torch.device, comm_model_name: str = "adaptive") -> Dict[str, Any]:
    ...
    if os.path.exists(radar_summary_path):
        ...
        summary["radar"] = train_radar_pipeline(cfg, device)
...
def parse_args() -> RunConfig:
    ...
    parser.add_argument("--out_dir", type=str, default="data/g5b")
    parser.add_argument("--data_root", type=str, default="data/g5b")
    ...
    parser.add_argument("--comm_model", choices=["adaptive", "bit"], default="adaptive")
...
def main() -> None:
    ...
    if cfg.mode == "train_radar":
        train_radar_pipeline(cfg, device)
    elif cfg.mode == "train_comm":
        train_comm_pipeline(cfg, device, model_name=cfg.comm_model)
    else:
        run_full_evaluation(cfg, device, comm_model_name=cfg.comm_model)
