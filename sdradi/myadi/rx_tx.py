...
#06/17/2024 copy from https://github.com/analogdevicesinc/pyadi-iio/blob/main/adi/rx_tx.py
...
if cl._is_libiio_v1():
    ...
    from myadi.compat import compat_libiio_v1_rx as crx
    #from adi.compat import compat_libiio_v1_tx as ctx
    from myadi.compat import compat_libiio_v1_tx as ctx
else:
    #from adi.compat import compat_libiio_v0_rx as crx
    from myadi.compat import compat_libiio_v0_rx as crx
    #from adi.compat import compat_libiio_v0_tx as ctx
    from myadi.compat import compat_libiio_v0_tx as ctx
