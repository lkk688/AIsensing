...
def setup_cn0566_radar(sdr_ip, phaser_ip):
    ...
    # 5. Configure PlutoSDR following mycn0566.py SDR_init() pattern
    #    FDD mode + debug attrs must be set BEFORE other SDR config
    ...
    ].value = "0"  # Disable pin control so SPI can move states
    sdr._ctrl.debug_attrs["initialize"].value = "1"
    import time as _time
    _time.sleep(3)  # Wait for AD9361 re-initialization to complete (needs 2-3s)
